...
const FileItem = ({
  ...
  return (
    <>
      ...
      {
        (type?.includes('/') ? type.split('/')[0] : type) === 'audio' && canPreview && previewUrl && (
          <AudioPreview
            title={name}
            url={previewUrl}
      ...
      {
        (type?.includes('/') ? type.split('/')[0] : type) === 'video' && canPreview && previewUrl && (
          <VideoPreview
            title={name}
            url={previewUrl}
            onCancel={() => setPreviewUrl('')}
      ...
      {
        (type?.includes('/') ? type.split('/')[1] : type) === 'pdf' && canPreview && previewUrl && (
