...
export function RetrievalResultItem({
  ...
  return (
    ...
    >
      {/* Header: Rank, Score, Document, Chunk */}
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-3">
          ...
          {/* Chunk Number */}
          <span className="px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-700 text-xs text-gray-600 dark:text-gray-400">
            {t('retrievalTest.chunk', { position: segment.position })}
          </span>
        </div>
