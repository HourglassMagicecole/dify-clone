"""JSON insert tool for adding values to JSON data."""
...
class JSONParseTool(BuiltinTool):
    """
    A tool for inserting values into JSON data.

    Supports JSONPath expressions to target insertion locations.
    """
