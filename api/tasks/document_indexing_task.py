...
def document_indexing_task(dataset_id: str, document_ids: list, session_id: str | None = None):
    """
    ...
    Usage: document_indexing_task.delay(dataset_id, document_ids, session_id)
    """
    documents = []
